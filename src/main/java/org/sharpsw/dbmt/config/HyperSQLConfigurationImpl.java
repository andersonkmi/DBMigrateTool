...
public class HyperSQLConfigurationImpl implements IDatabaseConfiguration {
	...
	public HyperSQLConfigurationImpl() {
		this.server = "";
		this.database = "";
		this.user = "";
		this.password = "";
	...
	public HyperSQLConfigurationImpl(String server, String database, Integer port, String user, String password, String driverClassName) {
		this.server = server;
