...
public class MSSQLServerConfigurationImpl implements IDatabaseConfiguration {
	public MSSQLServerConfigurationImpl() {
		this.server = "";
		this.instance = "";
	...
	public MSSQLServerConfigurationImpl(String driverClassName, String server, String instance, Integer port, String user, String password, String database) {
		this.server = server;
