...
public class OracleConfigurationImpl implements IDatabaseConfiguration {
	...
	public OracleConfigurationImpl(String driverClassName, String server, Integer port, String service, String user, String password) {
		this.server = server;
		this.port = port;
