...
public class MySQLConfigurationImpl implements IDatabaseConfiguration {
	...
	public MySQLConfigurationImpl(String server, Integer port, String database, String user, String password, String driverClassName) {
		this.server = server;
		this.port = port;
